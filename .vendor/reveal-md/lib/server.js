...
export default async () => {
  ...
  // Keep reveal-md's asset URL compatible with both root-level CSS and assets/ images.
  app.use(`/${assetsDir}`, staticDir(path.join(initialDir, assetsDir)));
  app.use(`/${assetsDir}`, staticDir(initialDir, { fallthrough: false }));
